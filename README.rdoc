...
Pg can optional type cast result and query parameters in Ruby and native
...
build ColumnMappings and to convert single values to/from their string
representation.
...
Connection#type_mapping= can be used to set a connection wide default type
mapping. It can also be used as alternative for parameters accepting
