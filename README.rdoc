...
Standard type casting for result and param values can be enabled by:

    conn.type_mapping = PG::BasicTypeMapping.new conn
    conn.exec("select 1, now()").values
        # => [[1, 2014-04-17 22:58:01 +0200]]
    conn.exec_params("SELECT $1, $2", [1, Time.now]).values
        # => [[1, 2014-04-17 22:58:47 +0200]]
