...
Basic type casting can be enabled by:
...
This is the lowest layer, containing encoding classes that convert Ruby
...
optionally a name to an encoder or decoder object. Inaddition for composite
types it is possible to assign the encoder/decoder of it's elements.
Coder objects can be used to convert single values to/from their string
representation and to build PG::ColumnMapping objects.
