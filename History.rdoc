...
Changed:
- Parsing of broken array strings raises a TypeError.
...
- Parsing and returning of broken array strings is deprecated.
  pg-2.0 will raise a TypeError in this case.
...
- Add PG::Result#tuple_values

Bugfixes:
- Properly decode array with prepended dimensions. #272
  For now dimension decorations are ignored, but a valid Array is returned.
  Moreover it raises TypeError for invalid input values.
