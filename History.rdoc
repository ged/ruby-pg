== v1.2.0 [YYYY-MM-DD] Michael Granger <ged@FaerieMUD.org>
...
- Update Windows fat binary gem to OpenSSL-1.1.1d and PostgreSQL-12.0.
...
- Fix PG::Result#stream_each and stream_each_tuple to delivers typemapped values.

Deprecated:
- Add a deprecation warning to Connection#socket .

Removed:
- Remove PG::Connection#guess_result_memsize= which was temporary added in pg-1.1.
- PG::Result.allocate and PG::Result.new (see enhancements).
- Support for tainted objects. #307
- Support of ruby-2.0 and 2.1. Minimum is ruby-2.2 now.

Documentation:
- Update description of connection params.
