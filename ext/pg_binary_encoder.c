...
init_pg_binary_encoder()
{
	...
	rb_cPG_BinaryEncoder_Simple = rb_define_class_under( rb_mPG_BinaryEncoder, "Simple", rb_cObject );
	rb_define_attr( rb_cPG_BinaryEncoder_Simple, "name", 1, 0 );
	...
	rb_cPG_BinaryEncoder_Composite = rb_define_class_under( rb_mPG_BinaryEncoder, "Composite", rb_cObject );
